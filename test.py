...
def main():
    ...
    print("Warning - you WILL get incorrect results if the pepe is part of a meme. The pepe must not be a part of a meme and must be a seperate picture")
    print("Warning - all test images MUST be jpg or else it will not be classified.")
